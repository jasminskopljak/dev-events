...
const EventDetailsItem = ({ icon, alt, label }: { icon: string; alt: string; label: string }) => (
  <div className="flex-row-gap-2 items-center" id="event-details-item">
  ...
  try {
    ...
    if (!request.ok) {
      if (request.status !== 404) {
        console.error(`Failed to fetch event: ${request.statusText}`);
      }
      return notFound();
    }
      ...
      <div className="details">
        ...
        <div className="content">
          ...
          <section className="flex-col-gap-2">
            ...
            <EventDetailsItem icon="/icons/mode.svg" alt="model" label={mode} />
